// mostLikedMovies.js for mostLikedMovies page
          ...
          <div class="movie-stats">
            <div class="stats-content pt-2">
              <div class="d-flex justify-content-between text-muted small">
                <span><i class="bi bi-eye"></i> ${movie.totalViews || '0'} görüntüleme</span>
...
async function fetchAndRenderMovies() {
  try {
    const response = await fetch(`${API_BASE_URL}/movies/getMostLikedMovies`,{credentials: 'include'});
